...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ FOOTER SHADER ÃÂ¢ÃÂÃÂ WebGL shader with animated noise and mouse flare ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        // Mouse flare ÃÂ¢ÃÂÃÂ warm glow follows cursor
        ...
        // Keep it subtle ÃÂ¢ÃÂÃÂ this is a background
        color *= 0.5;
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ FOOTER CSS HAZE ÃÂ¢ÃÂÃÂ Layered animated gradients that mimic smoke/aurora ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ FOOTER DIVIDER ÃÂ¢ÃÂÃÂ Bold accent seam with glow pulse ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
function FooterDivider({ visible, isMobile }) {
  return (
    <div style={{
      ...
      {/* Breathing wide glow ÃÂ¢ÃÂÃÂ slow pulse */}
      <div style={{
...
function Footer() {
  ...
  return (
    <footer ref={footerContainerRef} style={{
      paddingTop: 0,
      ...
      {/* Top fade ÃÂ¢ÃÂÃÂ the shader canvas will show through, and this fades it to bg color at the top edge */}
      <div style={{
        position: "absolute", top: 0, left: 0, right: 0, height: "30%",
        background: `linear-gradient(to bottom, ${T.bg} 0%, transparent 100%)`,
        pointerEvents: "none", zIndex: 2,
      }} />
      {/* Background effect ÃÂ¢ÃÂÃÂ WebGL shader on desktop, CSS haze on mobile */}
      ...
      <div style={{ position: "relative", zIndex: 1, padding: isMobile ? "0 28px" : "0 clamp(40px, 5vw, 80px)" }}>
        ...
        <h2 style={{
          ...
          {/* "life." with wave animation ÃÂ¢ÃÂÃÂ each letter undulates independently */}
          <span style={{
            display: "inline-block",
            opacity: visible ? 1 : 0,
